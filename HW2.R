...
#returns the amount of instances of Alzhimer in the data set 

colSums(is.na(meta))
#Lists the number of missing values for each of the columns, but does so in a summative way which is a bit cluttered 

newMeta = meta[!is.na(meta['Dopamine'])]
#sets newMeta to be the rows of meta that do not include a null value for dopamine 

newMeta[is.na(newMeta$c4.OH.Pro)] = median(newMeta$c4.OH.Pro)
#sets the na values at c4.OH.Pro to the median of c4.OH.Pro 
